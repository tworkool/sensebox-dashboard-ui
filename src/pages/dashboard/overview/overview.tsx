import { ActionIcon, Badge, Button, Chip, Grid, Group, Kbd, Modal, Stack, Switch, Text, TextInput, Title, Tooltip } from "@mantine/core";
        ...
        <Stack gap="sm">
          ...
          <Grid>
            ...
            <Grid.Col span={6}>
              <ValuePaper.Bare>
                <Stack>
                  <iframe style={{height: 300}} src="https://maps.google.com/maps?q=52.45608,13.628301&hl=en&z=14&output=embed"></iframe>
